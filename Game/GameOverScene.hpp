...
#ifndef GAMEOVERSCENE_HPP_
#define GAMEOVERSCENE_HPP_
...
class GameOverScene : public gameEngine::AScene {
    public:
        GameOverScene(gameEngine::AGame *game) : gameEngine::AScene(game)
        {
            ...
            getECS().addEntity<Image>(gameEngine::Vector2<float>(0.0f, 0.0f), gameEngine::Rectangle<int>(0, 0, 1920, 1080), "assets/Ui/Game over.png", 0U);
